...
public class IrUiMenu {
    ...
    public IrUiMenu(int id, int secuencia, boolean active, java.sql.Date createDate, String name) {
    ...
    public void meter() throws SQLException {
        ...
        try (Connection conectar = Conexion.conectar(); PreparedStatement pst = conectar.prepareStatement(sql)) {
            ...
            pst.setDate(4, cuenta.getCREATE_DATE());
            pst.setObject(5, cuenta.getNAME(), java.sql.Types.OTHER);
            pst.executeUpdate();
